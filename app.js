...
const cors= require('cors')  //for connect backend with frontend ==> take in app.use()

const mongoose = require("mongoose");
mongoose
  .connect("mongodb://localhost:27017/signupCrud")
  .then(() => {
...
app.use(cors()) // for connect backend with frontend
app.use(logger("dev"));
